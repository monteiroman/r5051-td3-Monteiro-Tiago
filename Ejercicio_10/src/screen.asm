...
result:
        ...
        mov     ecx, [sum_stored]               ; Parte baja del numero
        mov     edx, [sum_stored + 0x04]           ; Parte alta del numero
    ...
    ; Para la parte alta
        add     edi, 0x0E                       ; El loop anterior me deja 6 por debajo el valor de edi, hay que sumarlo y restar
                                                ;   2 para ubicar al primer nible de los de mas peso en su lugar.
        mov     eax, edx
