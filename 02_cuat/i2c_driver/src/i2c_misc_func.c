...
static void print_error_msg_w_status(char* e_action, char* e_file, char* e_func,
...
static void print_error_msg_wo_status(char* e_action, char* e_file, 
    char* e_func, int e_line){
...
// Information message.
static void print_info_msg(char* i_action, char* i_file, char* i_msg){
